...
sudo wget -nv https://raw.githubusercontent.com/pierre-pvln/conf-test/master/a/ipsec.conf -O ~/vpn/a/ipsec.conf

#get specific ipsec configuration file
sudo wget -nv https://raw.githubusercontent.com/pierre-pvln/conf-test/master/a/conn_A-L.conf -O ~/vpn/a/conn_A-L.conf
sudo wget -nv https://raw.githubusercontent.com/pierre-pvln/conf-test/master/a/conn_A-P.conf -O ~/vpn/a/conn_A-P.conf
...
sudo wget -nv https://raw.githubusercontent.com/pierre-pvln/conf-test/master/a/90-override.conf -O ~/vpn/a/90-override.conf
